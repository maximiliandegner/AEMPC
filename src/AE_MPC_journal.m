...
w_bar = w_max;
nF = 1;         % noise multiplication factor (used in true system propagation)
...
for t = 2:Tsim
    ...
    x_next = syst.dynamic(x_arr(:,t), u_sol(1:m,1), h, theta_true) + nF*noise_true;
...
switch type
    case "AEMPC"
        save(['Results/Simulations/AE_scaled--N_' , num2str(N),  '-Tsim_' , num2str(Tsim),  '-mu_', num2str(mu),  '-h_', num2str(h), '-LMS_', num2str(LMS), '-TV_', num2str(TV), 'noiseF_', num2str(nF),'.mat'], "w_arr", "u_arr", "v_arr", "x_arr", "z_arr", "xr_arr", "zr_arr", "sol", "theta_arr", "h", "Tsim", "mu", "w_bar", "Lw", "P", "P_f", "x_min", "x_max", "Tsolve_arr");
    case "EMPC_estimate"
        save(['Results/Simulations/E_wrong--N_' , num2str(N),  '-Tsim_' , num2str(Tsim),  '-mu_', num2str(mu),  '-h_', num2str(h), '-LMS_', num2str(LMS), '-TV_', num2str(TV), 'noiseF_', num2str(nF),'.mat'], "w_arr", "u_arr", "v_arr", "x_arr", "z_arr", "xr_arr", "zr_arr", "sol", "theta_arr", "h", "Tsim", "mu", "w_bar", "Lw", "P", "P_f", "x_min", "x_max", "Tsolve_arr");
    case "EMPC_perfect"
        save(['Results/Simulations/E_true--N_' , num2str(N),  '-Tsim_' , num2str(Tsim),  '-mu_', num2str(mu),  '-h_', num2str(h), '-LMS_', num2str(LMS), '-TV_', num2str(TV), 'noiseF_', num2str(nF),'.mat'], "w_arr", "u_arr", "v_arr", "x_arr", "z_arr", "xr_arr", "zr_arr", "sol", "theta_arr", "h", "Tsim", "mu", "w_bar", "Lw", "P", "P_f", "x_min", "x_max", "Tsolve_arr");
end
